...
main(int argc, char *argv[])
{
  ...
  2c:	ff 33                	pushl  (%ebx)
  2e:	e8 08 03 00 00       	call   33b <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bd:	f7 f1                	div    %ecx
 3bf:	0f b6 92 60 07 00 00 	movzbl 0x760(%edx),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 547:	e9 06 ff ff ff       	jmp    452 <printf+0x45>
          s = "(null)";
 54c:	bb 57 07 00 00       	mov    $0x757,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5e9:	a1 04 0a 00 00       	mov    0xa04,%eax
 ...
 5f8:	77 10                	ja     60a <free+0x2d>
{
 ...
 623:	89 08                	mov    %ecx,(%eax)
  freep = p;
 625:	a3 04 0a 00 00       	mov    %eax,0xa04
}
 62a:	5b                   	pop    %ebx
 62b:	5e                   	pop    %esi
 62c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 65d:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 660:	8b 15 04 0a 00 00    	mov    0xa04,%edx
 ...
 688:	eb 70                	jmp    6fa <malloc+0xaf>
    base.s.ptr = freep = prevp = &base;
 68a:	c7 05 04 0a 00 00 08 	movl   $0xa08,0xa04
 691:	0a 00 00 
 694:	c7 05 08 0a 00 00 08 	movl   $0xa08,0xa08
 69b:	0a 00 00 
    base.s.size = 0;
 69e:	c7 05 0c 0a 00 00 00 	movl   $0x0,0xa0c
 6a5:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 6a8:	ba 08 0a 00 00       	mov    $0xa08,%edx
 ...
 6bb:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 6be:	89 15 04 0a 00 00    	mov    %edx,0xa04
      return (void*)(p + 1);
 ...
 6df:	e8 f9 fe ff ff       	call   5dd <free>
  return freep;
 6e4:	8b 15 04 0a 00 00    	mov    0xa04,%edx
      if((p = morecore(nunits)) == 0)
 ...
 6fa:	89 c2                	mov    %eax,%edx
    if(p == freep)
 6fc:	39 05 04 0a 00 00    	cmp    %eax,0xa04
